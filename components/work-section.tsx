...
const experiments = [
  {
    ...
    description: "AI-powered browser IDE featuring real-time editing, AI code generation, autosave, and cloud sync.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "GrindX",
    medium: "Developer Platform",
    description: "Smart coding practice tracker integrating LeetCode, HackerRank, and GFG with ML-based recommendations.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Niraamya",
    medium: "AI Healthcare System",
    description: "Full-stack healthcare management platform with role-based APIs and a local LLM medical chatbot.",
    span: "col-span-1 row-span-2",
  },
  {
    title: "Freelance Systems",
    medium: "Production Web Apps",
    description: "Built client-facing full-stack applications with secure JWT authentication and optimized database schemas.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Developer Experiments",
    medium: "Web Interfaces",
    description: "Exploring interactive UI systems and experimental front-end architecture.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "AI Tooling",
    medium: "AI Systems",
    description: "Prototyping context-aware developer tools powered by LLMs and automation workflows.",
    span: "col-span-1 row-span-1",
  },
]
    ...
    <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-16 flex items-end justify-between">
        ...
        <p className="hidden md:block max-w-xs font-mono text-xs text-muted-foreground text-right leading-relaxed">
          Developer tools, AI systems, and production applications built for real-world impact.
        </p>
      </div>
